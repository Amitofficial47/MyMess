		...
		<div className="flex min-h-screen w-full flex-col items-center bg-background p-4 sm:p-8">
			<div className="w-full max-w-4xl space-y-6">
				...
				<Card>
					...
					<CardContent className="space-y-4 text-muted-foreground">
						<p className="font-semibold text-foreground">Welcome to MyMess!</p>
						<p>
							These terms and conditions outline the rules and regulations for
							the use of MyMess's Website, located at this application's domain.
						</p>
						<p>
							By accessing this website we assume you accept these terms and
							conditions. Do not continue to use MyMess if you do not agree to
							take all of the terms and conditions stated on this page.
						</p>
						...
						<p>
							MyMess provides a platform for hostel mess management, including
							meal selection, token generation, and administrative tools. The
						...
						<p>
							...
							are and will remain the exclusive property of MyMess and its
							licensors.
						</p>
						<h3 className="text-xl font-semibold text-foreground pt-4">
							4. Termination
